...
2. 下载原生 WSL 安装包
   ...
   2. 选一个你喜欢的 WSL 发行版
       ![image-20211226205044356](/images/post/20211216/image-20211226205044356.png)
   4. 下载 appx 文件
...
6. 双击EXE文件，就开始安装了
   ...
   ![image-20211226205637251](/images/post/20211216/image-20211226205637251.png)

7. 安装完成

   ![image-20211226205941186](/images/post/20211216/image-20211226205941186.png)
...
9. 如果哪天不想要这个环境了，CMD执行  `wsl -l` 找到要删除的环境，比如这里是Ubuntu-18.04
   ...
   ![image-20211226205752445](/images/post/20211216/image-20211226205752445.png)

10. 然后 `wsl --unregister Ubuntu-18.04` 

    ![image-20211226205847499](/images/post/20211216/image-20211226205847499.png)
