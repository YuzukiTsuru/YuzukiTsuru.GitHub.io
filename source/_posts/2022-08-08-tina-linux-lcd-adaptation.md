...
![](/images/post/2022-08-08-20220808/2022-07-28-10-13-05-image.png)
...
![](/images/post/2022-08-08-20220808/2022-08-08-11-01-35-image.png)

我们打开 `BoardConfig.mk` 配置文件

![](/images/post/2022-08-08-20220808/2022-08-08-11-02-10-image.png)

可以看到这颗芯片使用的是 `sun20iw1p1_defconfig` 这个配置文件。就可以在 U-Boot 的 `config`  文件夹找到这个配置文件。

![](/images/post/2022-08-08-20220808/2022-08-08-11-03-22-image.png)

打开它，可以在文件中找到 `SUNXI LOGO DISPLAY` 后面的部分，看到这两部分配置：

![](/images/post/2022-08-08-20220808/2022-08-08-11-06-09-image.png)
...
![](/images/post/2022-08-08-20220808/2022-08-08-11-09-36-image.png)
...
![](/images/post/2022-08-08-20220808/2022-07-28-10-28-57-image.png)
...
![](/images/post/2022-08-08-20220808/2022-07-28-10-34-14-image.png)
...
![](/images/post/2022-08-08-20220808/2022-07-28-10-49-24-image.png)
...
![](/images/post/2022-08-08-20220808/2022-07-28-11-01-46-image.png)
...
![](/images/post/2022-08-08-20220808/2022-07-29-11-21-12-image.png)
...
![](/images/post/2022-08-08-20220808/2022-07-28-14-43-02-lQDPJxaJmKYB5pXNA-jNBTawD_2BAMdUn8gC4oEJxQB4AA_1334_1000.jpg)
...
![](/images/post/2022-08-08-20220808/2022-07-29-10-18-53-image.png)
...
![](/images/post/2022-08-08-20220808/2022-07-28-15-03-58-image.png)

**Part 2**

在这一部分，我们配置了 LCD 屏幕的背光相关属性，使用 PWM 背光实现动态调整背光，可以在电路图中看到 LCD-PWM 使用的是 PWM9，所以配置 `lcd_pwm_ch = <9>;`

![](/images/post/2022-08-08-20220808/2022-07-28-15-26-15-image.png)
...
![](/images/post/2022-08-08-20220808/2022-07-28-15-28-55-image.png)
...
![](/images/post/2022-08-08-20220808/2022-07-29-09-31-42-image.png)
...
![](/images/post/2022-08-08-20220808/2022-07-29-09-57-00-image.png)
...
![](/images/post/2022-08-08-20220808/2022-07-29-10-25-14-image.png)
...
![](/images/post/2022-08-08-20220808/2022-07-29-10-27-41-image.png)
...
![](/images/post/2022-08-08-20220808/2022-07-29-11-23-39-lQDPJxaKPiYuWRjNC9DND8CwpcNMHGHqtAsC45AxYwD3AA_4032_3024.jpg)
...
![](/images/post/2022-08-08-20220808/2022-07-29-11-00-03-lQDPJxaKQp1l66DNC9DND8CwF8sNc9VJWPQC45eC98AtAA_4032_3024.jpg)
...
![](/images/post/2022-08-08-20220808/2022-07-29-11-02-37-image.png)
...
![](/images/post/2022-08-08-20220808/2022-08-08-14-11-45-image.png)

这里使用的屏幕是 【TL032FWV01-I1440A】驱动是 ST7701s，询问厂家得到了三份资料。

![](/images/post/2022-08-08-20220808/2022-08-08-11-45-58-image.png)

**lcd.h**

在这个文件中，定义了屏幕的一些时序信息。

![](/images/post/2022-08-08-20220808/2022-08-08-13-37-26-image.png)

**TL032FWV01-I1440A_specification(3).pdf**

在这个文件中，定义了屏幕的长宽高，分辨率等等

![](/images/post/2022-08-08-20220808/2022-08-08-11-49-51-image.png)

**TL032FWV01-I1440A_ST7701S(SPI9bit+RGB16bit)G2.2_V1.0(1).INI**

这个文件里定义了 SPI 的初始化时序信息，这里的 `W_C` 代表的写命令，`W_D` 代表写数据。 `Delay` 代表延时。

![](/images/post/2022-08-08-20220808/2022-08-08-11-55-52-image.png)
...
![](/images/post/2022-08-08-20220808/2022-08-08-12-00-01-image.png)

具体的 SPI 通讯的方法是使用函数模拟 SPI 的时序。并没有实际使用 SPI 外设。这样的好处是可以使用任意 GPIO 引脚，且初始化完成即可释放 GPIO。

![](/images/post/2022-08-08-20220808/2022-08-08-12-01-43-image.png)

首先为了方便区分，我们复制一份 `st7789v` 驱动，重命名为 `TL032FWV01`

![](/images/post/2022-08-08-20220808/2022-08-08-12-05-37-image.png)

并且把驱动内的 `st7789v` 全部改为 `TL032FWV01`

![](/images/post/2022-08-08-20220808/2022-08-08-12-04-51-image.png)

头文件也别忘记修改

![](/images/post/2022-08-08-20220808/2022-08-08-12-05-24-image.png)

**配置屏幕驱动**

第一部分是 `LCD_cfg_panel_info` 这一部分一般不需要修改，保留即可

![](/images/post/2022-08-08-20220808/2022-08-08-12-40-35-image.png)

第二部分是 LCD 上电下电相关，默认即可

![](/images/post/2022-08-08-20220808/2022-08-08-12-41-51-image.png)

第三部分是屏幕开启关闭与背光相关，对于这款屏幕也不需要修改

![](/images/post/2022-08-08-20220808/2022-08-08-12-42-40-image.png)

第四部分是 软件模拟 SPI 的部分，这里需要对照 ST7701s 数据手册修改为 ST7701s 的 SPI 时序。

![](/images/post/2022-08-08-20220808/2022-08-08-12-51-24-image.png)

主要添加了延时函数，因为 ST7701s 的 SPI 时钟较低，并修改对应的上升、下降触发方式。

![](/images/post/2022-08-08-20220808/2022-08-08-12-47-38-image.png)
...
![](/images/post/2022-08-08-20220808/2022-08-08-13-09-08-image.png)

第五部分是开关屏函数，原来的开关屏函数包括读取屏幕信息，这里我们不需要读取信息所以直接删除即可。开屏 `init` 部分调用 SPI 初始化屏幕参数即可。

![](/images/post/2022-08-08-20220808/2022-08-08-12-56-14-image.png)
...
![](/images/post/2022-08-08-20220808/2022-08-08-13-01-36-image.png)
...
![](/images/post/2022-08-08-20220808/2022-08-08-13-02-41-image.png)
...
![](/images/post/2022-08-08-20220808/2022-08-08-13-06-06-image.png)

编辑这个文件，新增屏幕的引索。配置名称叫做 `LCD_SUPPORT_TL032FWV01`

![](/images/post/2022-08-08-20220808/2022-08-08-13-17-36-image.png)
...
![](/images/post/2022-08-08-20220808/2022-08-08-13-21-57-image.png)
...
![](/images/post/2022-08-08-20220808/2022-08-08-13-24-13-image.png)
...
![](/images/post/2022-08-08-20220808/2022-08-08-13-25-57-image.png)
...
![](/images/post/2022-08-08-20220808/2022-08-08-13-29-35-image.png)

可以在编译的时候查看驱动是否被编译上了

![](/images/post/2022-08-08-20220808/2022-08-08-13-33-40-image.png)
...
![](</images/post/2022-08-08-20220808/2022-08-08-13-42-40-1659937356(1).png>)

#### 测试屏幕

没啥好说的，自己就亮了

![fa478e70-0bbb-47b9-850d-3304c7e9330b-771C24FE75B3C393F7290ED173626211.png](/images/post/2022-08-08-20220808/1658563661740-fa478e70-0bbb-47b9-850d-3304c7e9330b-771c24fe75b3c393f7290ed173626211-resized.png)
...
![](/images/post/2022-08-08-20220808/2022-08-08-14-17-22-image.png)

#### 适配前的准备

同样的，向屏厂索要屏幕资料。这次提供的资料如下：

![](/images/post/2022-08-08-20220808/2022-08-08-14-33-46-image.png)

一份数据手册与一份屏幕初始化代码。

在数据手册中，我们可以知道这个屏幕使用的是 ST7701s 驱动芯片，分辨率 800x320.

![](/images/post/2022-08-08-20220808/2022-08-08-14-28-02-image.png)

屏幕初始化代码中，配置了 MIPI 的时序，屏幕的亮度，GAMMA等等信息。

![](/images/post/2022-08-08-20220808/2022-08-08-14-34-57-image.png)

#### 编写驱动程序

同样的，这次是 MIPI DSI 屏幕，就使用 `ST7701s.c` 这个驱动修改即可。复制一份驱动文件夹，改名 `d310t9362v1` ，并全局替换 `st7701s` 到 `d310t9362v1`。

![](/images/post/2022-08-08-20220808/2022-08-08-14-42-39-image.png)
...
![](/images/post/2022-08-08-20220808/2022-08-08-15-01-41-image.png)
...
![](/images/post/2022-08-08-20220808/2022-08-08-15-37-06-image.png)
...
![](/images/post/2022-08-08-20220808/2022-08-08-15-16-04-image.png)

**（4）屏幕定义部分**

这一部分定义了屏幕的用户操作，屏幕的名称等等。

![](/images/post/2022-08-08-20220808/2022-08-08-15-17-14-image.png)
...
![](/images/post/2022-08-08-20220808/2022-08-08-15-20-41-image.png)
...
![](/images/post/2022-08-08-20220808/2022-08-08-15-35-39-image.png)
...
![](/images/post/2022-08-08-20220808/2022-08-08-15-23-42-image.png)
...
![](/images/post/2022-08-08-20220808/2022-08-08-15-25-14-image.png)

**内核配置**

`make kernel_menuconfig` 后，到 `Device Drivers > Graphics support > Frame buffer Devices > Video support for sunxi > LCD panels select` 找到屏幕，勾选即可。

![](/images/post/2022-08-08-20220808/2022-08-08-15-28-49-image.png)

勾选后编译可以看到驱动被编译了

![](/images/post/2022-08-08-20220808/2022-08-08-15-39-10-image.png)
...
![](/images/post/2022-08-08-20220808/2022-08-08-15-34-56-image.png)
...
![](/images/post/2022-08-08-20220808/UF7yMsL2GG5TRmLEoX08pLsfSj1ab2hVOCwrlMMb.jpeg)
...
![](/images/post/2022-08-08-20220808/2022-08-08-13-51-15-image.png)
...
![](/images/post/2022-08-08-20220808/2022-08-08-13-52-39-image.png)
...
![](/images/post/2022-08-08-20220808/2022-08-08-13-54-56-image.png)
...
![](/images/post/2022-08-08-20220808/2022-08-08-13-56-02-image.png)

### 增加 U-Boot 引索

打开屏幕驱动同目录下的 `Kconfig`，增加引索

![](/images/post/2022-08-08-20220808/2022-08-08-13-57-54-image.png)
...
![](/images/post/2022-08-08-20220808/2022-08-08-13-59-03-image.png)
...
![](/images/post/2022-08-08-20220808/2022-08-08-14-00-11-image.png)
...
![](/images/post/2022-08-08-20220808/2022-08-08-14-01-48-image.png)
...
![](/images/post/2022-08-08-20220808/2022-08-08-14-03-40-image.png)
...
![](/images/post/2022-08-08-20220808/2022-08-08-14-05-16-image.png)

### 编译测试

使用命令 `muboot` 编译 U-Boot，可以在编译的时候看到编译完成了。

![](/images/post/2022-08-08-20220808/2022-08-08-14-08-32-image.png)
...
![](/images/post/2022-08-08-20220808/2022-07-29-11-24-27-image.png)
...
![](/images/post/2022-08-08-20220808/2022-07-29-11-27-31-lQDPJxaKRoT30BzNC9DND8CwVUte5NSrp4sC453oqMDNAA_4032_3024.jpg)
...
![](/images/post/2022-08-08-20220808/2022-07-29-13-41-48-image.png)

打包烧写即可，替换 bootlogo 不需要编译

![](/images/post/2022-08-08-20220808/2022-07-29-13-41-27-lQDPJxaKWSobpBjNA-jNBTawhNYaqC5x2kkC47x1HcAyAA_1334_1000.jpg)
...
![](/images/post/2022-08-08-20220808/2022-08-08-15-45-35-image.png)

（3）配置启动 `console` 输出

打开项目文件夹内的 `env.cfg` 在 `console=${console}` 前加入 `console=tty0`，对应自己的 `setargs`，`mmc` 启动使用 `setargs_mmc` ，`nand` 启动使用 `setargs_nand`，以此类推。

![](/images/post/2022-08-08-20220808/2022-08-08-15-48-04-image.png)
