...
![img](/images/post/2023-02-15-v85x-e907-core-development/E907特性.jpg)
...
![image-20230215121222899](/images/post/2023-02-15-v85x-e907-core-development/image-20230215121222899.png)

## 芯片架构图

![image-20230215122305111](/images/post/2023-02-15-v85x-e907-core-development/image-20230215122305111.png)

## 相关内存分布

![image-20230215122626778](/images/post/2023-02-15-v85x-e907-core-development/image-20230215122626778.png)

![image-20230215122648192](/images/post/2023-02-15-v85x-e907-core-development/image-20230215122648192.png)

## E907 子系统框图

![image-20230215122832524](/images/post/2023-02-15-v85x-e907-core-development/image-20230215122832524.png)
...
![image-20220704155816774](/images/post/2023-02-15-v85x-e907-core-development/image-20220704155816774.png)
...
![image-20230215131405440](/images/post/2023-02-15-v85x-e907-core-development/image-20230215131405440.png)
...
![img](/images/post/2023-02-15-v85x-e907-core-development/2022-07-19-15-33-28-image.png)
...
![image-20230215133501502](/images/post/2023-02-15-v85x-e907-core-development/image-20230215133501502.png)
...
![image-20230215133017293](/images/post/2023-02-15-v85x-e907-core-development/image-20230215133017293.png)
...
![image-20230215133709126](/images/post/2023-02-15-v85x-e907-core-development/image-20230215133709126.png)
...
![image-20230215133820910](/images/post/2023-02-15-v85x-e907-core-development/image-20230215133820910.png)
...
![image-20230215133922058](/images/post/2023-02-15-v85x-e907-core-development/image-20230215133922058.png)
...
![image-20230215134015333](/images/post/2023-02-15-v85x-e907-core-development/image-20230215134015333.png)

## 配置小核系统

小核的编译框架与 `kernel` 类似，使用 `kconfig` 作为配置项。使用 `make menuconfig` 进入配置页。

![image-20230215134155560](/images/post/2023-02-15-v85x-e907-core-development/image-20230215134155560.png)
...
![2](/images/post/2023-02-15-v85x-e907-core-development/2.png)

如果设备树不做配置引脚和 `mux`，kernel会很贴心的帮你把没使用的 Pin 设置 `io_disable` 。由于使用的是 `iommu` 操作 `UART` 设备，会导致 `io` 不可使用。如下所示。

![4BBXHRX_1T@MH7K}{4TXNKY](/images/post/2023-02-15-v85x-e907-core-development/4BBXHRX_1T@MH7K}{4TXNKY.png)

![222](/images/post/2023-02-15-v85x-e907-core-development/222.png)
...
![image-20230215131216802](/images/post/2023-02-15-v85x-e907-core-development/image-20230215131216802.png)
...
![image-20230215135619996](/images/post/2023-02-15-v85x-e907-core-development/image-20230215135619996.png)
...
![image-20230215135802471](/images/post/2023-02-15-v85x-e907-core-development/image-20230215135802471.png)

然后就可以在 `/dev/` 下看到通讯节点 `/dev/rpmsg0`，`/dev/rpmsg1`

![image-20230215135907700](/images/post/2023-02-15-v85x-e907-core-development/image-20230215135907700.png)

也可以在小核控制台看到节点的建立

![image-20230215140011440](/images/post/2023-02-15-v85x-e907-core-development/image-20230215140011440.png)
...
![image-20230215140146824](/images/post/2023-02-15-v85x-e907-core-development/image-20230215140146824.png)

小核即可收到数据

![image-20230215140239518](/images/post/2023-02-15-v85x-e907-core-development/image-20230215140239518.png)
...
![image-20230215140457024](/images/post/2023-02-15-v85x-e907-core-development/image-20230215140457024.png)
...
![image-20230215140548983](/images/post/2023-02-15-v85x-e907-core-development/image-20230215140548983.png)

可以一直监听，例如多次发送数据

![image-20230215140641612](/images/post/2023-02-15-v85x-e907-core-development/image-20230215140641612.png)

Linux 侧获得的数据也会增加

![image-20230215140704356](/images/post/2023-02-15-v85x-e907-core-development/image-20230215140704356.png)
...
![image-20230215140946705](/images/post/2023-02-15-v85x-e907-core-development/image-20230215140946705.png)

同时 E907 也会打印链接关闭

![image-20230215140935523](/images/post/2023-02-15-v85x-e907-core-development/image-20230215140935523.png)
...
![image-20230215142007978](/images/post/2023-02-15-v85x-e907-core-development/image-20230215142007978.png)
