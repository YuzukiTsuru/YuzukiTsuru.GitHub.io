...
![img](../images/post/2024-02-22-t527-t113-s3-hifi4-dsp/tensilica-hifi-idma-128.jpg)

在 D1-H T113 A523 系列芯片中可以发现 HIFI4 的踪影

![image-20240222205218154](../images/post/2024-02-22-t527-t113-s3-hifi4-dsp/image-20240222205218154.png)
...
![image-20240222213136340](../images/post/2024-02-22-t527-t113-s3-hifi4-dsp/image-20240222213136340.png)

### 构建 FreeRTOS

构建固件非常简单，执行 `make` 即可，生成的固件在 `./build/dsp.elf` 下

![image-20240222213255206](../images/post/2024-02-22-t527-t113-s3-hifi4-dsp/image-20240222213255206.png)
...
![image-20231216174136154](../images/post/2024-02-22-t527-t113-s3-hifi4-dsp/image-20231216174136154.png)

编译后的可执行文件位于 `build/app` 中，这里包括 SyterKit 的多种APP可供使用。

![image-20231216173846369](../images/post/2024-02-22-t527-t113-s3-hifi4-dsp/image-20231216173846369.png)

进入 `load_hifi4`

![image-20240222214431758](../images/post/2024-02-22-t527-t113-s3-hifi4-dsp/image-20240222214431758.png)

按照需求选择，这里我们使用卡启动，所以使用 `load_hifi4_bin_card.bin`

![image-20240222214515148](../images/post/2024-02-22-t527-t113-s3-hifi4-dsp/image-20240222214515148.png)
...
![IMG_1366](../images/post/2024-02-22-t527-t113-s3-hifi4-dsp/IMG_1366.PNG)
