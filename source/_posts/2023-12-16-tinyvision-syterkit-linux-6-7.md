...
![image-20231216174136154](../images/post/2023-12-16-tinyvision-syterkit-linux-6-7/image-20231216174136154.png)

编译后的可执行文件位于 `build/app` 中，这里包括 SyterKit 的多种APP可供使用。

![image-20231216173846369](../images/post/2023-12-16-tinyvision-syterkit-linux-6-7/image-20231216173846369.png)

这里我们使用的是 `syter_boot` 作为启动引导。进入 syter_boot 文件夹，可以看到这些文件

![image-20231216174210790](../images/post/2023-12-16-tinyvision-syterkit-linux-6-7/image-20231216174210790.png)

由于 TinyVision 是 TF 卡启动，所以我们需要用到 `syter_boot_bin_card.bin`

![image-20231216174311727](../images/post/2023-12-16-tinyvision-syterkit-linux-6-7/image-20231216174311727.png)

# 移植 Linux 6.7 主线

有了启动引导，接下来是移植 Linux 6.7 主线，前往 [https://kernel.org/](https://kernel.org/) 找到 Linux 6.7，选择 `tarball` 下载

![image-20231216174444070](../images/post/2023-12-16-tinyvision-syterkit-linux-6-7/image-20231216174444070.png)
...
![image-20231216181640653](../images/post/2023-12-16-tinyvision-syterkit-linux-6-7/image-20231216181640653.png)
...
![image-20231216183011911](../images/post/2023-12-16-tinyvision-syterkit-linux-6-7/image-20231216183011911.png)
...
![image-20231216182350741](../images/post/2023-12-16-tinyvision-syterkit-linux-6-7/image-20231216182350741.png)

进入 `include/dt-bindings/reset` 新建文件 `sun8i-v851se-ccu.h` 将 RST 填入

![image-20231216182941392](../images/post/2023-12-16-tinyvision-syterkit-linux-6-7/image-20231216182941392.png)
...
![image-20231216180413415](../images/post/2023-12-16-tinyvision-syterkit-linux-6-7/image-20231216180413415.png)

将文件中的 `SUN20I_D1` 改为 `SUN8I_V851SE`

![image-20231216180653502](../images/post/2023-12-16-tinyvision-syterkit-linux-6-7/image-20231216180653502.png)
...
![image-20231216180748419](../images/post/2023-12-16-tinyvision-syterkit-linux-6-7/image-20231216180748419.png)

对照手册编写驱动文件适配 V851se 平台。

然后找到 `drivers/clk/sunxi-ng/Kconfig` 文件，增加刚才编写的驱动的 Kconfig 说明

![image-20231216181118674](../images/post/2023-12-16-tinyvision-syterkit-linux-6-7/image-20231216181118674.png)
...
![image-20231216181248375](../images/post/2023-12-16-tinyvision-syterkit-linux-6-7/image-20231216181248375.png)
...
![image-20231216183207387](../images/post/2023-12-16-tinyvision-syterkit-linux-6-7/image-20231216183207387.png)
...
![image-20231216183406918](../images/post/2023-12-16-tinyvision-syterkit-linux-6-7/image-20231216183406918.png)
...
![image-20231216183716548](../images/post/2023-12-16-tinyvision-syterkit-linux-6-7/image-20231216183716548.png)
...
![image-20231216183825726](../images/post/2023-12-16-tinyvision-syterkit-linux-6-7/image-20231216183825726.png)

同样的，修改 `drivers/pinctrl/sunxi/Kconfig` 增加选项

![image-20231216184038601](../images/post/2023-12-16-tinyvision-syterkit-linux-6-7/image-20231216184038601.png)

修改 `drivers/pinctrl/sunxi/Makefile` 增加路径

![image-20231216184126988](../images/post/2023-12-16-tinyvision-syterkit-linux-6-7/image-20231216184126988.png)
...
![image-20231216184259987](../images/post/2023-12-16-tinyvision-syterkit-linux-6-7/image-20231216184259987.png)
...
![image-20231216184649676](../images/post/2023-12-16-tinyvision-syterkit-linux-6-7/image-20231216184649676.png)
...
![image-20231216185413254](../images/post/2023-12-16-tinyvision-syterkit-linux-6-7/image-20231216185413254.png)
...
![image-20231216185113539](../images/post/2023-12-16-tinyvision-syterkit-linux-6-7/image-20231216185113539.png)

```
sun8i-v851se-tinyvision.dtb
```

![image-20231216185530270](../images/post/2023-12-16-tinyvision-syterkit-linux-6-7/image-20231216185530270.png)

# 生成刷机镜像

编译内核后，可以在文件夹 `arch/arm/boot/dts/allwinner` 生成`sun8i-v851se-tinyvision.dtb` ，在文件夹`arch/arm/boot` 生成 `zImage` ，把他们拷贝出来。

![image-20231216191248458](../images/post/2023-12-16-tinyvision-syterkit-linux-6-7/image-20231216191248458.png)
...
![image-20231216192512837](../images/post/2023-12-16-tinyvision-syterkit-linux-6-7/image-20231216192512837.png)
...
![image-20231216192612594](../images/post/2023-12-16-tinyvision-syterkit-linux-6-7/image-20231216192612594.png)
...
![image-20231216192702018](../images/post/2023-12-16-tinyvision-syterkit-linux-6-7/image-20231216192702018.png)

打包完成，可以找到 `sdcard.img`

![image-20231216192757467](../images/post/2023-12-16-tinyvision-syterkit-linux-6-7/image-20231216192757467.png)

使用软件烧录固件到TF卡上

![image-20231216192825808](../images/post/2023-12-16-tinyvision-syterkit-linux-6-7/image-20231216192825808.png)

# 测试

插卡，上电，成功启动系统

![image-20231216193758046](../images/post/2023-12-16-tinyvision-syterkit-linux-6-7/image-20231216193758046.png)

可以看到 Linux 版本是 6.7.0

![image-20231216193814799](../images/post/2023-12-16-tinyvision-syterkit-linux-6-7/image-20231216193814799.png)
